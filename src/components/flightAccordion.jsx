...
export default function FlightAccordion(props) {
  const {airline, flightClass, departureTime, arrivalTime, totalTime, type, departureAirportId, arrivalAirportId, price, date, dep_airport, code, arr_airport} = props;
    ...
    <div>
      <div id="accordion-collapse" data-accordion="collapse">
        <h2 id="accordion-collapse-heading-1">
          <button
            type="button"
            className={`flex items-center justify-between w-full p-5 font-medium rtl:text-right ${accordionOpen ? "rounded-t-xl border border-customBlue2" : "rounded-xl border"} shadow-inner gap-3`}
          ...
          >
            <span>
              ...
              <div className="flex items-center justify-between gap-72">
                ...
                <div>
                  <p className="text-customBlue1 font-bold text-xl">
                    {price}
                  </p>
                  <button className="bg-customBlue2 rounded-xl w-24 p-2 text-white">
                    Pilih
                  </button>
                </div>
              </div>
        ...
        <div
          ...
          className={`px-10 py-5 rounded-b-xl  ${
            accordionOpen ? "border border-customBlue2" : "hidden border" // Gunakan kelas "hidden" untuk menyembunyikan bagian accordion jika accordionOpen adalah false
          }`}
          ...
          <div className="">
            <div>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <div>
                    <p className="font-bold">{airline} - {flightClass}</p>
